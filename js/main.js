...
var newMap
var markers = []
// add listener when the DOM loaded to regisrer a service working
...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1IjoiZWxrb25zb2w4OCIsImEiOiJjamoxcGs2NW8waXNuM3ZtMWZiZDNmZmx5In0.qNRPlRlDfDiPYb8o51tWew',
    maxZoom: 18,
...
updateRestaurants = () => {
  ...
  // if the user navigate back to home
